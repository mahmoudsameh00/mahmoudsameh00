...
<div align="center">
  ...
  <a href="https://github.com/mahmoudsameh00">
...
| **Data & Tools** | ![Pandas](https://img.shields.io/badge/Pandas-150458?style=flat&logo=pandas&logoColor=white) ![Streamlit](https://img.shields.io/badge/Streamlit-FF4B4B?style=flat&logo=streamlit&logoColor=white) ![NumPy](https://img.shields.io/badge/NumPy-013243?style=flat&logo=numpy&logoColor=white) |

---

### 💼 Professional Experience

#### **LLM Developer (Remote)** | *G2i*
*Sep 2024 – Mar 2025*
* Refined Large Language Model (LLM) outputs to enhance accuracy and relevance.
* Executed advanced **prompt engineering** and evaluation strategies across diverse real-world use cases.
* Leveraged expertise in NLP and Data Science to optimize model performance.

#### **Deep Learning Engineer (Freelance)**
*3 Years Experience*
* Delivered custom Deep Learning and Computer Vision solutions for various clients.
* Specialized in model engineering, deployment, and data analysis.
...
* **Advanced Machine Learning Certification** - IEEE (2023)
* **Certified Data Scientist Professional** - Epsilon AI (2022)
